...
test.describe("SlackClient.generateBlocks()", () => {
  test('creates blocks with correct stats summary', async ({ testSlackClient: fakeSlackClient }) => {
  ...
  test('creates blocks when meta provided', async ({ testSlackClient: fakeSlackClient }) => {
    let generatedBlock = await fakeSlackClient.generateBlocks({
  ...
  test('creates blocks when test with attachment is provided', async ({ testSlackClient: fakeSlackClient }) => {
    let generatedBlock = await fakeSlackClient.generateBlocks({
